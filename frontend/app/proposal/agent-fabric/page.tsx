...
const agents: { name: string; role: string; tier: GovernanceTier; detail: string }[] = [
  ...
  {
    name: "Data Retention & Records Lifecycle Management",
    role: "Records-disposition governance (platform · data substrate)",
    tier: "data-plane",
    detail:
...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Fifty agents across three planes, two open protocols, one governed control plane"
