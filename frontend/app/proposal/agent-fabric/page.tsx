...
const agents: { name: string; role: string; tier: GovernanceTier; detail: string }[] = [
  ...
  {
    name: "Agentforce Risk Adjustment & HCC Coding",
    role: "Value-based-care documentation integrity: evidence-supported HCCs + RAF-style score + clinician-validated, never autonomously submitted (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Master Patient Index / Identity Resolution",
    role: "Identity/dedup layer (platform · data substrate)",
    tier: "data-plane",
    detail:
  ...
  {
    name: "Break-the-Glass / Emergency Access Governance",
    role: "Emergency-access governance (platform · data substrate)",
    tier: "data-plane",
    detail:
...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Forty-nine agents across three planes, two open protocols, one governed control plane"
