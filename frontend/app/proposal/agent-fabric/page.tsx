...
export const metadata = pageMetadata({
  ...
  description:
    "Pause-Health.ai's multi-agent architecture — Agentforce inbound lead generation, prospecting & nurture, qualification, intake, appointment scheduling, cosign-gated specialist referral management, claim-sourced member service / billing, clinician-gated prior authorization, engagement, proactive care-gap closure, and nudge-only medication adherence, the Anthropic Claude Care Router, the Pause MCP server, the MuleSoft integration plane, and a PHI-separated commercial plane (pipeline + account management + deal desk) — orchestrated, monitored, and governed by a MuleSoft Agent Fabric control plane.",
...
const phases = [
  {
    ...
    duration: "Today",
    detail:
      `${AGENT_CARD_COUNT_WORD} agents registered on the mocked Agent Fabric across four planes. The patient/clinical plane runs the full lifecycle — inbound lead generation, prospecting & nurture, qualification, Agentforce intake, validated-instrument assessment, benefits & coverage verification, patient financial assistance & charity care, good faith estimates (No Surprises Act), advance beneficiary notice (Medicare ABN), the Claude Care Router, lab result & critical-value notification, immunization forecasting (ACIP), controlled-substance / PDMP safety, drug–drug interaction safety, care-pathway sequencing, care planning, appointment scheduling, specialist referrals, engagement, care-gap closure, medication adherence, clinical summaries, SDOH screening, patient education, remote monitoring, population health, clinical-trials matching, language access, HEDIS quality, advance care planning, care-team management, caseload balancing (care-manager panel assignment), scheduling conflict / double-booking guard, transitions of care, grievance & appeals, quality attribution, complex care management, trial payments, care-coordination handoff, adverse-event reporting, TEFCA data-sharing, and risk-adjustment coding. A PHI-bearing payer & plan operations plane runs claims adjudication, formulary/DUR review, fraud-waste-abuse detection, utilization review, coordination of benefits, claims overpayment & recovery, timely-filing compliance, subrogation / third-party liability, member cost-share / EOB calculation, medical loss ratio (MLR) rebate calculation, eligibility & enrollment (834) reconciliation, creditable coverage continuity, OIG exclusion / sanctions screening, and No Surprises Act balance-billing protection — plan-side, human-cosign-gated, never an autonomous adverse determination. The platform & data substrate carries the Pause MCP server, the MCP Bridge, the MuleSoft integration plane, Data 360 grounding, provider credentialing, and the consent, master-patient-index, break-the-glass, records-retention, de-identification (Safe Harbor), minimum-necessary (purpose-of-use), audit-log-integrity (tamper-evidence), access-anomaly-detection (HIPAA §164.308 activity review), accounting-of-disclosures (HIPAA §164.528), right-of-access (HIPAA §164.524), amendment / correction (HIPAA §164.526), and information blocking (Cures Act / 45 CFR Part 171) services. The PHI-separated commercial plane runs pipeline management, account management, provider contracting, and deal desk / quote approval (CPQ). Every agent declares its governance policies; every A2A handoff and MCP tool call lands as a trace span; the deterministic fallback holds wherever live Claude is used. End-to-end A2A handoff Agentforce → Care Router, an MCP tool surface, and the /demo/agent-fabric console for monitoring. Live in this repo.`
  },
  {
