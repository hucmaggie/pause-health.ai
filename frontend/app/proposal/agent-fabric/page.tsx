...
const agents: { name: string; role: string; tier: GovernanceTier; detail: string }[] = [
  ...
  {
    name: "Agentforce Clinical Summary",
    role: "After-visit summary + clinician handoff (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Data-Sharing / TEFCA Interoperability",
    role: "Cross-org PHI exchange: HIPAA §164.506 TPO gate + TEFCA participant verification + consent scopes (care coordination)",
    tier: "care-coordination",
    detail:
...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Forty-six agents across three planes, two open protocols, one governed control plane"
