...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Nineteen agents across three planes, two open protocols, one governed control plane"
      subtitle="Pause-Health.ai composes Agentforce (inbound lead generation, prospecting & nurture, qualification, intake, validated-instrument assessment, benefits & coverage verification, appointment scheduling, cosign-gated specialist referral management, engagement, proactive care-gap closure, and nudge-only medication adherence, plus a PHI-separated commercial plane for pipeline & account management), Anthropic Claude (clinical routing and template-sourced care planning with a live-Claude progress summary), the Pause MCP server (data-plane tools), MuleSoft (integration plane), and Data 360 (grounding) into a single multi-agent system — orchestrated, monitored, secured, and governed by a MuleSoft Agent Fabric control plane."
    >
