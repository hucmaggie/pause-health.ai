...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Thirty-six agents across three planes, two open protocols, one governed control plane"
