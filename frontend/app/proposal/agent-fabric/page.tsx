...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Thirty-five agents across three planes, two open protocols, one governed control plane"
