...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Twenty-two agents across three planes, two open protocols, one governed control plane"
      subtitle="Pause-Health.ai composes Agentforce (inbound lead generation, prospecting & nurture, qualification, intake, validated-instrument assessment, benefits & coverage verification, appointment scheduling, cosign-gated specialist referral management, engagement, proactive care-gap closure, nudge-only medication adherence, and after-visit clinical summary, plus a PHI-separated commercial plane for pipeline & account management), Anthropic Claude (clinical routing, template-sourced care planning with a live-Claude progress summary, and a live-Claude after-visit summary + clinician handoff), the Pause MCP server (data-plane tools), MuleSoft (integration plane), and Data 360 (grounding) into a single multi-agent system — orchestrated, monitored, secured, and governed by a MuleSoft Agent Fabric control plane."
    >
