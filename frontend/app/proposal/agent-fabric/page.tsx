...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Twenty-eight agents across three planes, two open protocols, one governed control plane"
