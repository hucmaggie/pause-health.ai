...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Twenty-nine agents across three planes, two open protocols, one governed control plane"
