...
const agents: { name: string; role: string; tier: GovernanceTier; detail: string }[] = [
  ...
  {
    name: "Agentforce Grievance & Appeals",
    role: "Regulated intake: classify + route to a human queue + stamp a regulatory deadline (patient-facing)",
    tier: "patient-facing",
    detail:
  ...
  {
    name: "Agentforce Provider Credentialing & Directory",
    role: "Network-integrity gate: verify a provider + gate every referral / scheduling attempt (integration plane)",
    tier: "integration",
    detail:
  ...
  {
    name: "Agentforce Quality-Measure Attribution",
    role: "Who counts on whose panel: attribute each patient to a provider + VBC contract for HEDIS scoring (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Complex Care Management (CCM)",
    role: "Reimbursable time-tracking: CCM eligibility + monthly minutes + CPT-coded billing package (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Claims Adjudication Assistant",
    role: "First-pass payer-side: catalog edits + reason codes + adjudicator cosign (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Formulary & Drug Utilization Review",
    role: "First-pass drug review: tier + step-therapy + quantity + interactions + clinician cosign (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Fraud, Waste & Abuse Detection",
    role: "Pattern-based SIU screening: flag suspicious claims for human review, never autonomously deny (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Clinical Trial Payments & Stipends",
    role: "IRB-schedule payment engine: participant stipends + travel + coordinator cosign (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Utilization Review (MCG/InterQual analog)",
    role: "Pre-service medical-necessity screen: catalog criteria + clinician-cosign + SLA integrity (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Adverse Event Reporting (FDA MedWatch / VAERS analog)",
    role: "Pharmacovigilance / device-safety reporting: MedWatch or VAERS drafts + regulatory-team cosign (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Care Coordination Handoff (Cross-Setting)",
    role: "Joint-Commission-NPSG-2 SBAR for any cross-setting transition (care coordination)",
    tier: "care-coordination",
    detail:
  ...
  {
    name: "Agentforce Provider Contracting & VBC Terms",
    role: "Commercial-plane contract classification + VBC benchmark computation + account-owner cosign (commercial operations)",
...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Forty-one agents across three planes, two open protocols, one governed control plane"
