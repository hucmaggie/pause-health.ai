...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      subtitle="Pause-Health.ai composes Agentforce, Anthropic Claude, the Pause MCP server, MuleSoft, and Salesforce Data 360 into a single multi-agent system spanning three governed planes — a patient/clinical plane (acquisition → qualification → intake → Claude routing → post-visit care), a shared platform & data substrate (grounding, integration, and the consent / identity / emergency-access / retention services), and a strictly PHI-separated commercial plane. Four agents call live Claude (clinical routing, care-plan and after-visit summaries, and patient-education coaching), each with a deterministic fallback. Every agent's role, tier, and governance posture is enumerated by plane below — orchestrated, monitored, secured, and governed by a MuleSoft Agent Fabric control plane."
    >
