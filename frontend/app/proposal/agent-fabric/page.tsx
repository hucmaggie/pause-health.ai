...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Thirty-eight agents across three planes, two open protocols, one governed control plane"
