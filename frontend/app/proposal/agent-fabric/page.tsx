...
export default function AgentFabricInvestorPage() {
  return (
    <ProposalShell
      ...
      title="Twenty-seven agents across three planes, two open protocols, one governed control plane"
