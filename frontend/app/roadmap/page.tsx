    ...
    items: [
      {
        ...
        detail:
          "Reproducible smoke-test script at frontend/scripts/smoke-test.mjs. Hits 38 routes, follows 102 unique internal links, POSTs realistic fixtures to 17 API endpoints. Current run (2026-06-24): 160 / 160 pass. Run via `npm run smoke` against a local dev server; results land in SMOKE_TEST_RESULTS.md. Re-runnable after every polish pass.",
        status: "prototype",
