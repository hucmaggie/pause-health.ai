...
const weeks: ChangelogWeek[] = [
  {
    ...
    entries: [
      {
        title: "Agent Fabric: added the Care Team & Case Management agent — deterministic multi-disciplinary team assembly + case-manager assignment + PCP-anchor invariant (the 32nd agent)",
        summary:
        ...
        commits: [
          {
            sha: "e71e1d0",
            label:
              "agent fabric: add the Care Team & Case Management agent (deterministic multi-disciplinary team assembly + case-manager assignment + PCP-anchor invariant, the 32nd agent)"
          }
        ],
        status: "shipped"
      },
      {
        title: "Agent Fabric: added the Advance Care Planning agent — deterministic midlife-touchpoint directive assessment + human-signoff-gated proposals + LEP-safe conversation prompts (the 31st agent)",
        summary:
        ...
        commits: [
          {
            sha: "ebd6631",
            label:
              "agent fabric: add the Advance Care Planning agent (deterministic midlife-touchpoint directive assessment + human-signoff-gated proposals + LEP-safe conversation prompts, the 31st agent)"
          }
        ],
        status: "shipped"
      },
      {
        title: "Agent Fabric: added the HEDIS & Quality Reporting agent — deterministic panel-level HEDIS measure rollup + catalog-sourced exclusions + human-approved submission (the 30th agent)",
        summary:
        ...
        commits: [
          {
            sha: "2f18998",
            label:
              "agent fabric: add the HEDIS & Quality Reporting agent (deterministic panel-level HEDIS measure rollup + catalog-sourced exclusions + human-approved submission, the 30th agent)"
          }
        ],
        status: "shipped"
      },
      {
        title: "Agent Fabric: added the Language Access & Health Equity agent — deterministic qualified-interpreter-only language access + approved-source materials + equity-gap flagging (the 29th agent)",
        summary:
        ...
        commits: [
          {
            sha: "4e5c0f0",
            label:
              "agent fabric: add the Language Access & Health Equity agent (deterministic qualified-interpreter-only language access + approved-source materials + equity-gap flagging, the 29th agent)"
          }
        ],
        status: "shipped"
      },
