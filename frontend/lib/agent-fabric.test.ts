...
describe("Benefits & Coverage Verification (EBV) · Benefits agent", () => {
  it("brings the registry to sixty-two agents", () => {
    ...
    // language-access + hedis-quality + advance-care-planning +
    // care-team-management + transitions-of-care + grievance-appeals +
    // provider-credentialing + quality-attribution + complex-care-management
    // + claims-adjudication + formulary-review + fwa-detection +
    // trial-payments + utilization-review + coordination-of-benefits +
    // overpayment-recovery + balance-billing +
    ...
    // Beneficiary Notice / Medicare ABN agent, the Member Cost-Share / EOB
    ...
    // care-coordination PCP Assignment / Member–Provider Matching agent, the
    ...
    // the data-plane Clinical Code Taxonomy / Longest-Prefix Classification agent,
    ...
    // and the care-coordination Chart Review Batch Partitioning / Linear Partition (Binary-Search-on-Answer) agent.
    expect(listAgents()).toHaveLength(100);
