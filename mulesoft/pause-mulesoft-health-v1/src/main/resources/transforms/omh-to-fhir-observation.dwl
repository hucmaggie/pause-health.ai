%dw 2.0
/*
  Pause-Health.ai — OMH sample -> FHIR R5 Observation

  Input: single OMH IEEE 1752.1 envelope (one element from the array).
  Output: FHIR R5 Observation object (embedded into a Bundle entry).
