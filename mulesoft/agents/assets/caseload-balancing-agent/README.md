# Caseload Balancing (Care-Manager Panel Assignment) Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `caseload-balancing-agent`
- **Artifact:** `pause-agent-caseload-balancing-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.caseload.assignment-complete, policy.caseload.capacity-respected, policy.caseload.no-autonomous-assignment
