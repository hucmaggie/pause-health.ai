# Member Contact Rate Limiting / Token-Bucket Throttle Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `contact-rate-limit-agent`
- **Artifact:** `pause-agent-contact-rate-limit-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.contactrate.replay-sourced, policy.contactrate.throttle-exact, policy.contactrate.no-autonomous-send
