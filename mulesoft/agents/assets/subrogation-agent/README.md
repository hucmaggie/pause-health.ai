# Subrogation / Third-Party Liability Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `subrogation-agent`
- **Artifact:** `pause-agent-subrogation-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** payer-operations
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.subrogation.basis-sourced, policy.subrogation.recoverable-within-paid, policy.subrogation.no-autonomous-lien
