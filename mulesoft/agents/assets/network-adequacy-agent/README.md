# Network Adequacy / Time-and-Distance Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `network-adequacy-agent`
- **Artifact:** `pause-agent-network-adequacy-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** payer-operations
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.adequacy.providers-sourced, policy.adequacy.distances-consistent, policy.adequacy.no-autonomous-network-change
