...
- **Fabric agent id:** `provider-benchmarking-agent`
- **Artifact:** `pause-agent-provider-benchmarking-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** commercial-operations
- **Posture:** non-PHI
- **Policies enforced (3):** policy.benchmark.cohort-sourced, policy.benchmark.stats-consistent, policy.benchmark.no-autonomous-tiering
