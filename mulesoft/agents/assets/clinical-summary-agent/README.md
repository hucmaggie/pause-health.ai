# Agentforce Clinical Summary Agent · After-Visit Summary

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `clinical-summary-agent`
- **Artifact:** `pause-agent-clinical-summary-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (5):** policy.audit.hipaa-log-every-turn, policy.clinical-summary.source-record-sourced, policy.model.anthropic-claude-sonnet-allowlisted, policy.clinical.no-prescribing, policy.data360.consent-required-before-grounding
