# Risk Adjustment & HCC Coding Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `risk-adjustment-agent`
- **Artifact:** `pause-agent-risk-adjustment-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.riskadj.evidence-supported-coding, policy.riskadj.clinician-validation-required, policy.riskadj.no-autonomous-submission
