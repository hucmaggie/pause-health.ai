# Audit Log Integrity (Tamper-Evidence) Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `audit-log-integrity-agent`
- **Artifact:** `pause-agent-audit-log-integrity-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** mulesoft-process / A2A
- **Governance tier:** data-plane
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.auditlog.hash-chain-verified, policy.auditlog.sequence-complete, policy.auditlog.no-autonomous-redaction
