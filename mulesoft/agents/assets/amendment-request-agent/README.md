# Amendment / Correction (HIPAA §164.526) Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `amendment-request-agent`
- **Artifact:** `pause-agent-amendment-request-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** mulesoft-process / A2A
- **Governance tier:** data-plane
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.amendment.ground-sourced, policy.amendment.deadline-computed, policy.amendment.no-autonomous-write-or-denial
