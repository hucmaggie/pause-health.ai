# Reportable / Notifiable Condition Case Classification Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `reportable-condition-agent`
- **Artifact:** `pause-agent-reportable-condition-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.reportable.facts-sourced, policy.reportable.classification-consistent, policy.reportable.no-autonomous-report
