# Primary Care Provider (PCP) Assignment / Member–Provider Matching Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `pcp-matching-agent`
- **Artifact:** `pause-agent-pcp-matching-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.pcp.matching-sourced, policy.pcp.matching-stable, policy.pcp.no-autonomous-assignment
