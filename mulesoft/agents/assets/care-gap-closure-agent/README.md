...
- **Fabric agent id:** `care-gap-closure-agent`
- **Artifact:** `pause-agent-care-gap-closure-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-gap
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (6):** policy.audit.hipaa-log-every-turn, policy.caregap.clinical-measure-sourced, policy.data360.consent-required-before-grounding, policy.marketing.consent-to-contact-required, policy.marketing.human-approval-before-send, policy.engagement.quiet-hours-and-channel-preference
