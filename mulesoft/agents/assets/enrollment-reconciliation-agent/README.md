# Eligibility & Enrollment (834) Reconciliation Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `enrollment-reconciliation-agent`
- **Artifact:** `pause-agent-enrollment-reconciliation-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** payer-operations
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.enrollment.reconciliation-complete, policy.enrollment.actions-sourced, policy.enrollment.no-autonomous-change
