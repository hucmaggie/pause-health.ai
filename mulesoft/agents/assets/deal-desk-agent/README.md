# Deal Desk / Quote Approval Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `deal-desk-agent`
- **Artifact:** `pause-agent-deal-desk-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** commercial-operations
- **Posture:** non-PHI
- **Policies enforced (4):** policy.commercial.no-phi-in-commercial-plane, policy.dealdesk.pricing-catalog-sourced, policy.dealdesk.discount-math-consistent, policy.dealdesk.no-autonomous-out-of-guardrail-approval
