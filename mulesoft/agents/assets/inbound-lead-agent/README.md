# Agentforce Inbound Lead Generation · Site & Chat

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `inbound-lead-agent`
- **Artifact:** `pause-agent-inbound-lead-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** patient-acquisition
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (3):** policy.audit.hipaa-log-every-turn, policy.lead.explicit-optin-and-source-required, policy.lead.identity-resolution-before-create
