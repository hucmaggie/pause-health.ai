...
- **Fabric agent id:** `complex-care-management-agent`
- **Artifact:** `pause-agent-complex-care-management-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.ccm.eligibility-catalog-sourced, policy.ccm.no-autonomous-billing, policy.ccm.time-integrity
