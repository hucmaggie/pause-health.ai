# Master Patient Index / Identity Resolution Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `master-patient-index-agent`
- **Artifact:** `pause-agent-master-patient-index-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** mulesoft-process / A2A
- **Governance tier:** data-plane
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.mpi.transparent-matching, policy.mpi.no-autonomous-merge, policy.mpi.no-protected-class-matching
