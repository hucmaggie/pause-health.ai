# Provider Credentialing & Directory Agent

Anypoint Exchange **Agents** asset (A2A v0.3 card, classifier `a2a-card`).

- **Fabric agent id:** `provider-credentialing-agent`
- **Artifact:** `pause-agent-provider-credentialing-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** integration
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.credentialing.source-integrity, policy.credentialing.no-referral-to-expired-or-sanctioned, policy.credentialing.no-surprises-act-directory-accuracy
