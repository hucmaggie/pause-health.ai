...
- **Fabric agent id:** `care-coordination-handoff-agent`
- **Artifact:** `pause-agent-care-coordination-handoff-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.handoff.sbar-completeness, policy.handoff.receiving-clinician-credentialed, policy.handoff.consent-on-file
