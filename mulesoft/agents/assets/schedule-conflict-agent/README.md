...
- **Fabric agent id:** `schedule-conflict-agent`
- **Artifact:** `pause-agent-schedule-conflict-agent` `1.0.0` (groupId `56707cc3-a0e3-4318-b110-78126aace370`)
- **Kind / protocol:** agentforce / A2A
- **Governance tier:** care-coordination
- **Posture:** PHI-adjacent (HIPAA-audit / consent policies apply)
- **Policies enforced (4):** policy.audit.hipaa-log-every-turn, policy.schedule.intervals-sourced, policy.schedule.conflict-free, policy.schedule.no-autonomous-booking
